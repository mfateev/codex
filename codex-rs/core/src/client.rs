...
impl ModelStreamer for ModelClientSession {
    async fn stream(
        ...
        ModelClientSession::stream(self, prompt, model_info, session_telemetry, effort, summary, service_tier, turn_metadata_header).await
    }
    ...
    fn try_switch_fallback_transport(
        ...
        ModelClientSession::try_switch_fallback_transport(self, session_telemetry, model_info)
    }
}
